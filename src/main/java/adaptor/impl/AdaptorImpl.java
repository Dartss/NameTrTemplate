...
/**
 * 
 * Adaptor serves as main manager on worker side - it is a medium between
 * manager and workers threads
 * 
 * @author rud
 *
 */
public class AdaptorImpl extends UnicastRemoteObject implements Adaptor, Serializable
{
	...
	try
	{
	    // this.LOGGER.info("returning job to manager - " + new
	    // JsonHandlerImpl().serialize(jobVO));
