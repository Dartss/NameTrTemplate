...
import jsmarty.core.common.apis.social.helpers.facebook.graph.GraphApiHelper;
 ...
 *
 */
public class FBGraphApiHandlerImpl implements StatsApiHandler
{

    private GraphApiHelper graphApiHelper;

    public FBGraphApiHandlerImpl() {
    ...
    private ParseStatus handleErrors(FacebookOAuthException exception)
    {
	...
	status.setError_message(exception.getErrorMessage());
	return status;
    }
